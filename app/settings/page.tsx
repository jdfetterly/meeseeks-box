...
import { DemoResetButton } from '@/components/dev/DemoResetButton'
        ...
        <section style={{ marginBottom: 'var(--space-8)' }}>
          ...
          >
            <p style={{ marginTop: 0, color: 'var(--text-secondary)' }}>
              Reset a realistic development dataset for Home, Work, Chat, Inbox, Schedules, Artifacts, and Memory.
            </p>
            <DemoResetButton />
          </div>
        </section>
